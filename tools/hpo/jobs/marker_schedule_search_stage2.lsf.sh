#!/usr/bin/env bash
#BSUB -J hpo_marker_stage2_schedule
#BSUB -q gpua100
#BSUB -n 1
#BSUB -W 10:00
#BSUB -R "rusage[mem=24GB]"
#BSUB -oo outputs/lsf_logs/hpo_marker_stage2_schedule.%J.out
#BSUB -eo outputs/lsf_logs/hpo_marker_stage2_schedule.%J.err
...
HPO_CONFIG="${HPO_CONFIG:-src/config/hpo/marker_directed/schedule_search_stage2.yaml}"
