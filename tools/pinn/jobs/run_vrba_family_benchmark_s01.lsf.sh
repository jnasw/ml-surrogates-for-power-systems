#!/usr/bin/env bash
#BSUB -J vrba_family_benchmark_s01
#BSUB -q gpua100
#BSUB -n 1
#BSUB -W 24:00
#BSUB -R "rusage[mem=16GB]"
#BSUB -oo outputs/lsf_logs/vrba_family_benchmark_s01.%J.out
#BSUB -eo outputs/lsf_logs/vrba_family_benchmark_s01.%J.err
...
if ! "${PYTHON_BIN}" -c "import omegaconf" >/dev/null 2>&1; then
  ...
  echo "[ERROR] submit with PYTHON_BIN=/path/to/venv/bin/python bsub < tools/pinn/jobs/run_vrba_family_benchmark_s01.lsf.sh"
  exit 1
fi
