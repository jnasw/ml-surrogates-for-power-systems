#!/usr/bin/env bash
#BSUB -J benchmark_sm4_smoke
#BSUB -q gpua100
#BSUB -n 1
#BSUB -W 01:00
#BSUB -R "rusage[mem=2GB]"
#BSUB -oo outputs/lsf_logs/benchmark_sm4_smoke.%J.out
#BSUB -eo outputs/lsf_logs/benchmark_sm4_smoke.%J.err
...
echo "[benchmark_sm4_smoke] campaign_manifest=${CAMPAIGN_MANIFEST}"
echo "[benchmark_sm4_smoke] metrics_csv=${METRICS_OUT}"
