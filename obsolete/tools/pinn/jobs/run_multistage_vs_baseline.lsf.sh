...
MULTISTAGE_STAGE_PLANS="${MULTISTAGE_STAGE_PLANS:-Adam:300||LBFGS:100@@@Adam:300||LBFGS:100||Adam:1000||SSBroyden:300@@@Adam:300||LBFGS:100||Adam:1000||LBFGS:100}"
...
echo "[multistage-vs-baseline] multistage_stage_plans=${MULTISTAGE_STAGE_PLANS}"
if [[ -n "${PRESET}" ]]; then
