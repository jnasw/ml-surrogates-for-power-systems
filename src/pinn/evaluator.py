...
def move_pinn_dataset_to_device(
    ...
    *,
    ...
    return PinnDatasetBundle(
        ...
        train_traj_ids=None if dataset.train_traj_ids is None else dataset.train_traj_ids.to(device=device),
        train_difficulty_scores=None if dataset.train_difficulty_scores is None else dataset.train_difficulty_scores.to(device=device, dtype=torch.float32),
        train_difficulty_bins=None if dataset.train_difficulty_bins is None else dataset.train_difficulty_bins.to(device=device),
