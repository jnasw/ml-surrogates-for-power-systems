...
STRATEGY_REGISTRY: dict[str, dict[str, Any]] = {
    "adam_30000": {
        ...
        "stages": [
            [("adam", "Adam", 1e-3, 30_000)],
        ],
    },
    "adam_ssbroyden_2stage": {
        "pinn_mode": "multistage",
        "stages": [
            [("adam", "Adam", 1e-3, 15_000)],
...
def _adam_phase_dict(*, name: str, epochs: int, batch_size: int, lr: float = 1e-3) -> str:
    return (
        "{"
        f"name:{name},"
        "optimizer:Adam,"
